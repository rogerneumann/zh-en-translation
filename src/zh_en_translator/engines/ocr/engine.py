"""Unified OCR interface — waterfall: PaddleOCR → Windows OCR → Tesseract."""
...
def is_any_engine_available() -> bool:
    ...
    return (
        paddle_ocr.is_available()
        or windows_ocr.is_available()
...
def ocr_image(image_bytes: bytes, lang: str = "zh") -> str | None:
    ...
    Waterfall order: PaddleOCR → Windows OCR (winsdk) → Tesseract
    """
